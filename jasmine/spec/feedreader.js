...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
         it('feed\'s URL present', function() {
         ...
         */
         it('feed\'s name present', function() {
            allFeeds.forEach((feed) => {
    ...
    describe('Initial Entries', function() {
        ...
        let feed = document.getElementsByClassName('feed')[0];
         ...
         beforeEach(function(done) {
            // clear the feeds
            feed.innerHTML = '';
            // loadFeed calls done() after loading the feeds
            loadFeed(0, done);
         });
    ...
    describe('New Feed Selection', function() {
        ...
        beforeEach(function(done) {
            loadFeed(0, () => {
                // get initial entries
                oldEntries = feed.innerHTML;
                loadFeed(1, () => {
                    // get new entries
                    newEntries = feed.innerHTML;
                    done();
                });
            });
        });
